            ...
            <div className="p-6 space-y-6">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <Link href="/admin/clients/create">
                        <Button className="h-12 px-6 bg-gradient-to-r from-primary via-primary/80 to-primary hover:from-primary/90 hover:via-amber-700 hover:to-primary/90 text-white shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all duration-300 hover:scale-105 rounded-xl">
                        ...
                        <div className="relative w-full overflow-auto">
                            <table className="w-full caption-bottom text-sm">
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {items.map((client) => (
                                        <tr key={client.id} className="group hover:bg-gradient-to-r hover:from-primary/5 hover:to-primary/60/5 transition-all duration-300">
