                                ...
                                <tbody className="divide-y divide-border/30">
                                    {groupItemsByDate(items, (i: Quote) => i.created_at || i.date).flatMap(group => [
                                        ...
                                        ...group.items.map((quote) => (
                                            <tr key={quote.id}  className="group hover:bg-gradient-to-r hover:from-indigo-500/5 hover:to-blue-500/5 transition-all duration-300 group hover:bg-muted/30 transition-colors">
                                                ...
                                                <td className="p-4 align-middle text-right">
                                                    <div className="flex justify-end gap-1">
                                                        ...
                                                        <Button variant="ghost" size="icon" asChild title="Voir PDF" className="h-8 w-8 text-blue-500 hover:text-blue-600 hover:bg-blue-50">
                                                            <a href={`/admin/api/quotes/${quote.id}/pdf/view`} target="_blank">
                                                        ...
                                                        <Button variant="ghost" size="icon" asChild title="Télécharger PDF" className="h-8 w-8 text-indigo-500 hover:text-indigo-600 hover:bg-indigo-50">
                                                            <a href={`/admin/api/quotes/${quote.id}/pdf/download`} target="_blank">
