                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody className="[&_tr:last-child]:border-0">
                                {loading ? (
                                    ...
                                    <tr>
                                        <td className="p-12 text-center" colSpan={6}>
                                            <div className="flex flex-col items-center justify-center">
                                                ...
                                                <h3 className="text-lg font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Aucun produit trouvé</h3>
                                    ...
                                    items.map((p) => (
                                        <tr key={p.id} className="border-b border-white/5 transition-all hover:bg-primary/50/5 group">
                                            <td className="px-6 py-4 align-middle">
                                                <div className="h-12 w-12 rounded-lg bg-muted/50 flex items-center justify-center overflow-hidden border border-white/10 group-hover:border-primary/30 transition-colors">
                                                    {p.image_url ? (
                                            ...
                                            <td className="px-6 py-4 align-middle">
                                                <div className="flex flex-col gap-1">
                                                    {p.category ? (
                                                        <span className="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-medium bg-gradient-to-r from-primary/10 to-primary/60/10 text-primary border border-primary/20 w-fit">
                                                            {p.category.name}
                                                        </span>
                                                    ) : (
                                                ...
                                                <div className="flex justify-center">
                                                    {(() => {
                                                        ...
                                                        if (qty <= 0) {
                                                            ...
                                                            statusBg = "bg-gradient-to-r from-amber-500/10 to-primary/10 border-amber-500/30";
                                                            Icon = AlertTriangle;
                                                        }
