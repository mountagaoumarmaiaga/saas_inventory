...
export default function ShowQuote({ id }: ShowQuoteProps) {
    ...
    const handleDownloadPdf = () => {
        window.open(`/user/api/quotes/${id}/pdf/download`, '_blank');
    };

    const handlePrint = () => {
        window.open(`/user/api/quotes/${id}/pdf/view`, '_blank');
    };

    const handleEdit = () => {
        router.visit(`/user/quotes/${id}/edit`);
    };
                ...
                <div className="p-4">
                    <Card>
                        <CardContent className="p-8 text-center">
                            ...
                            <Button onClick={() => router.visit('/user/quotes')} className="mt-4">
                                Retour à la liste
                            </Button>
                        </CardContent>
                    </Card>
