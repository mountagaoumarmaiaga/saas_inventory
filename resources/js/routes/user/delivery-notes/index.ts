...
* @route '/user/delivery-notes/{id}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/user/delivery-notes/{id}/edit',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/user/delivery-notes/{id}/print'
*/
...
print.definition = {
    methods: ["get","head"],
    url: '/user/delivery-notes/{id}/print',
} satisfies RouteDefinition<["get","head"]>
