...
<body>
    <table class="header-table">
        <tr>
            ...
            <td class="header-right">
                ...
                <div class="invoice-meta"><strong>N° Commande :</strong> {{ $purchase->number }}</div>
                <div class="invoice-meta"><strong>Date :</strong> {{ \Carbon\Carbon::parse($purchase->order_date)->format('d/m/Y') }}</div>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td style="width: 40%; vertical-align: top;">
                <table class="totals-table" style="width: 100%;">
                    <tr>
                        <td>Total HT</td>
                        <td class="text-right">{{ $formatCurrency(($purchase->total_amount - $purchase->tax_amount)) }}</td>
                    </tr>
    ...
    <div class="footer">
        ...
        @else
            ...
            <div>{{ $purchase->entreprise->address ?? '' }} — {{ $purchase->entreprise->email ?? '' }}</div>
