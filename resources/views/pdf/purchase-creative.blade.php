...
<body>
    ...
    <div class="center">
        ...
        <div class="invoice-number">Réf : {{ $purchase->number }} | Date : {{ \Carbon\Carbon::parse($purchase->order_date)->format('d/m/Y') }}</div>
    </div>
        ...
        <tr>
            <td style="padding-right: 20px;">
                <div class="info-block bordered">
                    ...
                    <div class="name">{{ $purchase->entreprise->name ?? 'Entreprise' }}</div>
            ...
            <td style="padding-left: 20px;">
                <div class="info-block">
                    ...
                    <div class="name">{{ $purchase->supplier->name ?? 'Fournisseur Inconnu' }}</div>
                    <div style="color: #71717a;">
