...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Big BON DE COMMANDE title below logo */
        .facture-title-block {
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="meta-cell" style="width:50%;">
                <div class="meta-row">DATE : {{ \Carbon\Carbon::parse($purchase->date)->format('d / m / Y') }}</div>
                <div class="meta-row">ÉCHÉANCE : {{ $purchase->due_date ? \Carbon\Carbon::parse($purchase->due_date)->format('d / m / Y') : 'À RÉCEPTION' }}</div>
                <div class="meta-row facture-number">BON DE COMMANDE N° : {{ $purchase->number }}</div>
            </td>
        </tr>
    </table>
</div>

<!-- GIANT BON DE COMMANDE TITLE -->
                ...
                <td class="totals-col">
                    <table class="totals-table">
                        <tr>
                            ...
                            <td class="val">{{ $formatCurrency($purchase->subtotal ?? 0) }}</td>
                        </tr>
                        @if(($purchase->tva ?? 0) > 0)
                        <tr>
                            <td class="lbl">TVA {{ $purchase->tva }}% :</td>
                        ...
                        <tr class="grand-total">
                            ...
                            <td class="val">{{ $formatCurrency($purchase->total ?? 0) }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
