    ...
    <table class="header-top">
        <tr>
            <td class="company-zone">
                ...
                @endif
                <div class="company-name">{{ $purchase->entreprise->name ?? 'Entreprise' }}</div>
            ...
            <td class="invoice-title-zone">
                <div class="invoice-word">BON DE COMMANDE</div>
    ...
    <table class="meta-grid">
        <tr>
            <td class="meta-box client-box">
                ...
                <div class="client-name">{{ $purchase->supplier->name ?? 'Fournisseur Inconnu' }}</div>
            ...
            <td class="meta-box details-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $purchase->number }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Date</span>
                    <span class="detail-value">{{ \Carbon\Carbon::parse($purchase->order_date)->format('d/m/Y') }}</span>
                </div>
                ...
                <div class="detail-row" style="margin-top: 10px; padding-top: 10px; border-top: 1px solid #e2e8f0;">
                    ...
                    <span class="detail-value" style="color: #0284c7; font-size: 16px;">{{ $formatCurrency($purchase->total_amount) }}</span>
                </div>
                @endif
            </td>
        </tr>
    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right price-val" style="color: #0f172a; font-weight: bold;">{{ $formatCurrency($item->total_price) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div class="totals-section" style="page-break-inside: avoid;">
        ...
        <div class="totals-box">
            <table class="totals-table">
                <tr>
                    <td>Total HT</td>
                    <td class="val">{{ $formatCurrency(($purchase->total_amount - $purchase->tax_amount)) }}</td>
                </tr>
                ...
                <tr class="grand-total">
                    <td>TOTAL TTC</td>
                    <td class="val">{{ $formatCurrency($purchase->total_amount) }}</td>
                </tr>
            </table>
        </div>
        <div class="clear"></div>
