...
<body>
    <table class="header-table">
        <tr>
            ...
            <td class="header-right">
                ...
                <div class="invoice-meta"><strong>N° Devis :</strong> {{ $quote->number }}</div>
                <div class="invoice-meta"><strong>Date :</strong> {{ \Carbon\Carbon::parse($quote->date)->format('d/m/Y') }}</div>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td style="width: 40%; vertical-align: top;">
                <table class="totals-table" style="width: 100%;">
                    ...
                    <tr>
                        <td>TVA ({{ $quote->tva }}%)</td>
                        <td class="text-right">{{ $formatCurrency($quote->subtotal * $quote->tva / 100) }}</td>
                    </tr>
                    @endif
                    <tr class="total-row">
                        <td>NET À PAYER TTC</td>
                        <td class="text-right">{{ $formatCurrency($quote->total) }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div class="footer">
        ...
        @else
            ...
            <div>{{ $quote->entreprise->address ?? '' }} — {{ $quote->entreprise->email ?? '' }}</div>
