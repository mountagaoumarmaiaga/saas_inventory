...
<body>
    ...
    <div class="center">
        ...
        <div class="invoice-number">Réf : {{ $quote->number }} | Date : {{ \Carbon\Carbon::parse($quote->date)->format('d/m/Y') }}</div>
    </div>
        ...
        <tr>
            <td style="padding-right: 20px;">
                <div class="info-block bordered">
                    ...
                    <div class="name">{{ $quote->entreprise->name ?? 'Entreprise' }}</div>
            ...
            <td style="padding-left: 20px;">
                <div class="info-block">
                    ...
                    <div class="name">{{ $quote->client->name ?? 'Client Inconnu' }}</div>
                    <div style="color: #71717a;">
