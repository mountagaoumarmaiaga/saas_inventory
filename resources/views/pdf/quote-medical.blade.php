            ...
            <tr>
                ...
                <td style="width: 50%; text-align: right;">
                    ...
                    <div class="doc-meta">
                        ...
                        <span class="meta-label">VALIDITÉ :</span> {{ $quote->due_date ? \Carbon\Carbon::parse($quote->due_date)->format('d/m/Y') : '1 mois' }}
                    </div>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td style="padding-left: 15px;">
                    <div class="info-block">
                        ...
                        <div class="entity-name">{{ $quote->client->name ?? '' }}</div>
                        <div class="entity-details">
                            {!! nl2br(e($quote->client->address ?? '')) !!}<br>
                            @if($quote->client->phone ?? null)<strong>Tél:</strong> {{ $quote->client->phone }}<br>@endif
                            @if($quote->client->email ?? null)<strong>Email:</strong> {{ $quote->client->email }}@endif
                        </div>
                    </div>
                </td>
            </tr>
