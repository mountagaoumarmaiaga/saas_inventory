    ...
    <table class="header">
        <tr>
            <td style="width: 50%;">
                ...
                @endif
                <div class="company-name">{{ $quote->entreprise->name ?? 'Studio Créatif' }}</div>
                <div style="color: #666666;">
                    {{ $quote->entreprise->address ?? '' }}<br>
                    {{ $quote->entreprise->phone ?? '' }}<br>
                    {{ $quote->entreprise->email ?? '' }}
                </div>
            </td>
            <td style="width: 50%; text-align: right;">
                <div class="invoice-title">Devis</div>
                <div class="invoice-number">{{ $quote->number }}</div>
                <div style="color: #888888; margin-top: 15px;">Date d'émission : {{ \Carbon\Carbon::parse($quote->date)->format('d.m.Y') }}</div>
            </td>
        </tr>
    </table>
    ...
    <div class="totals-wrapper">
        ...
        <div class="totals-right">
            <table class="totals-table">
                ...
                @if($quote->tva > 0)
                <tr>
                    <td style="color: #666666;">TVA ({{ $quote->tva }}%)</td>
