    ...
    <table class="header-top">
        <tr>
            <td class="company-zone">
                ...
                @endif
                <div class="company-name">{{ $quote->entreprise->name ?? 'Entreprise' }}</div>
            ...
            <td class="invoice-title-zone">
                <div class="invoice-word">DEVIS</div>
    ...
    <table class="meta-grid">
        <tr>
            <td class="meta-box client-box">
                ...
                <div class="client-name">{{ $quote->client->name ?? 'Client Inconnu' }}</div>
            ...
            <td class="meta-box details-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $quote->number }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Date</span>
                    <span class="detail-value">{{ \Carbon\Carbon::parse($quote->date)->format('d/m/Y') }}</span>
                </div>
                @if($quote->total > 0)
                <div class="detail-row" style="margin-top: 10px; padding-top: 10px; border-top: 1px solid #e2e8f0;">
                    ...
                    <span class="detail-value" style="color: #0284c7; font-size: 16px;">{{ $formatCurrency($quote->total) }}</span>
                </div>
                @endif
            </td>
        </tr>
    ...
    <div class="totals-section" style="page-break-inside: avoid;">
        ...
        <div class="totals-box">
            <table class="totals-table">
                <tr>
                    <td>Total HT</td>
                    <td class="val">{{ $formatCurrency($quote->subtotal) }}</td>
                </tr>
                @if($quote->tva > 0)
                <tr>
                    <td>TVA ({{ $quote->tva }}%)</td>
                    <td class="val">{{ $formatCurrency($quote->subtotal * $quote->tva / 100) }}</td>
                </tr>
                @endif
                <tr class="grand-total">
                    <td>TOTAL TTC</td>
                    <td class="val">{{ $formatCurrency($quote->total) }}</td>
                </tr>
            </table>
        </div>
        <div class="clear"></div>
